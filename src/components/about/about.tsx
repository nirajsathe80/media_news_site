...
const About = () => {
  return (
    <section className="flex items-center py-10 bg-stone-100  font-poppins dark:bg-gray-800 ">
            ...
            <div className="bg-gray-100 min-h-screen py-10">
              <div className="container mx-auto px-4">
                ...
                <p className="text-lg mb-6">
                  At JournalMotion, we are more than just a news media platform;
                  we are your gateway to the world&apos;s latest events, trends,
                  and developments. With a commitment to delivering timely and
                  accurate news coverage, we strive to keep our audience
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg mb-6">
                    From breaking news stories to in-depth analyses, our team of
                    dedicated journalists works tirelessly to bring you the most
                    relevant and up-to-date information. Whether it&apos;s
                    politics, business, technology, health, or culture, we cover
                    a wide range of topics to ensure that you stay informed
                    about the issues that impact your life.
                  </p>
                  <h2 className="text-xl font-semibold mb-2">
                  ...
                  <p className="text-lg mb-6">
                    ...
                    objectively and impartially. Our commitment to truthfulness,
                    accuracy, and transparency is unwavering, ensuring that our
                    readers can trust the information they receive from us.
                  </p>
                  <h2 className="text-xl font-semibold mb-2">
                    Founder&apos;s Vision
                  </h2>
                  <p className="text-lg mb-6">
                    ...
                    JournalMotion was born out of a passion for journalism and a
                    desire to make a positive impact on society. With years of
                    experience in the media industry, Vishal envisioned a
