...
function BlogPageCommonStructure() {
  return (
    <div className="container my-24 mx-auto md:px-6">
      <section className="mb-32">
        ...
        <p className="mb-6 rounded border-l-4 border-neutral-800 bg-neutral-100 p-2 rounded-lg">
        ...
        <img
          src={`https://images.pexels.com/photos/2872418/pexels-photo-2872418.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2`}
...
export default BlogPageCommonStructure;
